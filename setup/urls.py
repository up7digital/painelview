...
from Painel_Web.views import SelecionarPainelView, SelecionarSetor, PainelView, mercure_proxy, painel_dados, personalizacao_css
...
urlpatterns = [
    ...
    path("selecionar/paineis-por-setor/", SelecionarSetor.as_view(), name="paineis_por_setor"),
